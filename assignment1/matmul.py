...
#matrix1 is a list of empty lists, making one of the dimensions of the matrix 0, which makes it undefined.
...
#Checks if a code can run with float values.
...
#Checks if the code can handle complex values entries. 
...
#Checks if error is thrown if a 3D matrix is given.
    def test_3D(self):
        matrix1 = [[-1, -2], [-3, -4]]
        matrix2 = [[[1,2,3], 6], [7, 8]]
...
#one of the matrices is not a list of lists.
